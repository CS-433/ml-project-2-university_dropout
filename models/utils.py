def make_prompt(techniques=[]):
    ...
    template = (
        ...
        "{context_str}"
        "\n---------------------\n"
        "Répond à la question: {query_str}.\n"
    ...
    if "few-shot" in techniques:
        template = template.replace("Paragraphes pertinents.\n",
            ...
            ---------------------
            Répond à la question: Quels sont les principaux domaines d'investissement dans l'éducation selon le discours?
            {{
        ...
        #     ---------------------
        #     Répond à la question: Sur quelles sources d'énergie renouvelables l'orateur s'est-il concentré dans son discours?
        #     {{
