...
def get_query(question, context, model_output):
    query = (
        ...
        f"Here is a piece of text that contains some information related to the above queation:\n{context}\n\n"
...
with open('logs/quality_metrics.txt', 'a') as log_file:
    # for technique_list in [[], ['cot'], ['few-shot'], ['cot', 'few-shot'], ['cot', 'few-shot', 'reit', 'right', 'rawinst', 'pos']]:
    for technique_list in [['few-shot']]:
    # for technique_list in [['cot', 'reit', 'right', 'rawinst', 'pos']]:
        try:
